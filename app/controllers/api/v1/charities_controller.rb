class Api::V1::CharitiesController < Api::V1::BaseController
    ...
    def charity_params
        params.require(:charity).permit(::id, :name, :aged, :instagram, :facebook, :website, :city, :country, :income, :country_focus, :size, :program_percentage, :cost_to_100, :fiveohone, :phone, :email, :mission, :goal, :age, :issues, :photo)
      end
